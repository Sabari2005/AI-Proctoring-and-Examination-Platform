...
class NumericalSection(QWidget):
    def __init__(
        self,
        question_text: str = (
            "Calculate the time complexity of binary search "
            "(Provide the answer in constant numeric equivalent, e.g., if O(1) type 1)."
        ),
    ):
        super().__init__()
        ...
        self.answer_input.setPlaceholderText("0.00")
        self.answer_input.setFixedWidth(250)
        # Accept any floating-point number
        self.answer_input.setValidator(QDoubleValidator())
